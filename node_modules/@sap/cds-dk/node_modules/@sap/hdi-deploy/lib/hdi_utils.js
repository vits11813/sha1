 ...
 * @returns {Object} addedLocalFiles and deletedLocalFiles, deployedLocalFiles files.
 */
function prepareSync (result, content) {
  let deployedFilesSystemFiles = [];
  const deletedLocalFiles = [];
  const addedLocalFiles = [];
  // deployedLocalFiles are files that are already deployed and are either modified or unmodified
  const deployedLocalFiles = [];
...
module.exports = {prepareSync, prepareOptimiseMake, prepareMake, getDefaultPermissionSet, handle_client_files};
